...
@Tag(name = "Assignments", description = "Run and inspect book assignment results for a class period")
...
public class AssignmentController {
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "403", description = "Authenticated teacher does not own the class period"),
      @ApiResponse(responseCode = "404", description = "Class period not found")
  })
  public RunAssignmentResponse runAssignment(
      @Parameter(description = "Class period identifier", required = true)
